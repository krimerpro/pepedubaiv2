  ...
  <div class="container-large">
    <div class="footer-wrapper"><img src="{{ asset('images/Lgo-Main.png') }}" loading="lazy" alt="" class="footer-logo">
      ...
      <div class="footer-link-wrapper">
        <a href="https://www.dextools.io/app/en/bnb/pair-explorer/0x4a64bc89550127005c7c14fc82debe6e0422d5a9" target="_blank" class="footer-link w-inline-block">
          <div>Chart</div>
        </a>
        <a href="https://bscscan.com/token/0x30d14d8F30024C1953d8bb6D086434268F35D0e8" target="_blank" class="footer-link w-inline-block">
          <div>Contract</div>
        </a>
