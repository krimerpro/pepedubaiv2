  ...
  <div class="container-large">
    <div class="footer-wrapper"><img src="{{ asset('images/Lgo-Main.png') }}" loading="lazy" alt="" class="footer-logo">
      ...
      <div class="footer-link-wrapper">
        <a href="https://poocoin.app/tokens/0xDCAd007D0F542aeDD8e3CA79f1615Bb72266307f" target="_blank" class="footer-link w-inline-block">
          <div>Chart</div>
        </a>
        <a href="https://bscscan.com/token/0xDCAd007D0F542aeDD8e3CA79f1615Bb72266307f" target="_blank" class="footer-link w-inline-block">
          <div>Contract</div>
        </a>
