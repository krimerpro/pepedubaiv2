  ...
  <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navigation w-nav">
    <div class="navigation-container">
      ...
      <nav role="navigation" class="navigation-menu w-nav-menu">
        ...
        <a href="https://pancakeswap.finance/swap?outputCurrency=0xbE17Eb018fef6f07e4785bf6433a800bf5b6b1cd" target="_blank" class="button-primary-nav show w-button">Buy Pepe Dubai 2.0</a>
      </nav>
      <div class="navigation-wrapper">
        ...
        <a href="https://pancakeswap.finance/swap?outputCurrency=0xbE17Eb018fef6f07e4785bf6433a800bf5b6b1cd" target="_blank" class="button-primary-nav w-button">Buy Pepe Dubai 2.0</a>
      </div>
    </div>
  </div>
      ...
      <div class="w-layout-grid header-grid">
        <div id="w-node-d2a82d26-fa98-d3d9-4fee-b982f88ebb3f-b39babc3" class="header-block">
          ...
          <div data-w-id="d2a82d26-fa98-d3d9-4fee-b982f88ebb47" style="opacity:1" class="button-wrapper">
            ...
            <a href="https://bscscan.com/token/0xbE17Eb018fef6f07e4785bf6433a800bf5b6b1cd" target="_blank" class="button-secondary w-inline-block">
              <div>CONTRACT</div>
            </a>
          </div>
